...
$(BUILD_DIRECTORY)/gui/Gui.o: $(SRC_DIRECTORY)/gui/Gui.cpp $(SRC_DIRECTORY)/gui/Gui.h $(SRC_DIRECTORY)/Graphic.h
	$(CREATE_TARGET_DIRECTORY)
	$(CC) $(CFLAGS) -o $@ -c $<

	
$(BUILD_DIRECTORY)/map/Building.o: $(SRC_DIRECTORY)/map/Building.cpp $(MAP_HEADER_FILES)
	$(CREATE_TARGET_DIRECTORY)
	$(CC) $(CFLAGS) -o $@ -c $<
	
$(BUILD_DIRECTORY)/map/Map.o: $(SRC_DIRECTORY)/map/Map.cpp $(MAP_HEADER_FILES) $(SRC_DIRECTORY)/GraphicsMgr.h
	$(CREATE_TARGET_DIRECTORY)
	$(CC) $(CFLAGS) -o $@ -c $<
	
	
$(BUILD_DIRECTORY)/sound/SoundMgr.o: $(SRC_DIRECTORY)/sound/SoundMgr.cpp $(SRC_DIRECTORY)/sound/SoundMgr.h
	$(CREATE_TARGET_DIRECTORY)
	$(CC) $(CFLAGS) -o $@ -c $<
	
	
$(BUILD_DIRECTORY)/Graphic.o: $(SRC_DIRECTORY)/Graphic.cpp $(SRC_DIRECTORY)/Graphic.h
	$(CREATE_TARGET_DIRECTORY)
	$(CC) $(CFLAGS) -o $@ -c $<
	
$(BUILD_DIRECTORY)/GraphicsMgr.o: $(SRC_DIRECTORY)/GraphicsMgr.cpp $(SRC_DIRECTORY)/GraphicsMgr.h
	$(CREATE_TARGET_DIRECTORY)
	$(CC) $(CFLAGS) -o $@ -c $<
	
$(BUILD_DIRECTORY)/main.o: $(SRC_DIRECTORY)/main.cpp $(SRC_DIRECTORY)/gui/Gui.h $(SRC_DIRECTORY)/map/Map.h $(SRC_DIRECTORY)/sound/SoundMgr.h $(SRC_DIRECTORY)/GraphicsMgr.h
	$(CREATE_TARGET_DIRECTORY)
	$(CC) $(CFLAGS) -o $@ -c $<
