...
void AbstractGraphicsMgr::loadGraphics() {
    ...
    loadStaticGraphicSetWith4Views("mapobjects/bakery", "data/img/buildings/bakery.png");
    ...
    loadStaticGraphicSet("add-building-button/bakery", "data/img/gui/add-building/bakery.png");
...
void AbstractGraphicsMgr::loadCarrierGraphicSet() {
    IGraphic* sdlFullGraphic = loadGraphic("data/img/animations/carrier.png");
