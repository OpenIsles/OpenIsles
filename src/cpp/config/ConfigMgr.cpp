...
void ConfigMgr::loadBuildingConfig() {
    ...
    for (int i = StructureType::COBBLED_STREET_STRAIGHT_0; i <= StructureType::COBBLED_STREET_CROSS; i++) {
        ...
        buildingConfigs[structureType]->structurePlacing = StructurePlacing::PATH;
    ...
    for (int i = StructureType::SQUARE1; i <= StructureType::SQUARE3; i++) {
        ...
        buildingConfigs[structureType] = new BuildingConfig();
        buildingConfigs[structureType]->structurePlacing = StructurePlacing::RECTANGLE;
        buildingConfigs[structureType]->catchmentArea = nullptr;
        buildingConfigs[structureType]->buildingCosts = { 5, 0, 0, 1 };
        buildingConfigs[structureType]->buildingProduction = { GoodsSlot(), GoodsSlot(), GoodsSlot() };
    }
    ...
    buildingConfigs[StructureType::CHAPEL]->structurePlacing = StructurePlacing::INDIVIDUALLY;
    ...
    for (int i = 1; i <= 5; i++) {
        ...
        buildingConfigs[structureType]->structurePlacing = StructurePlacing::INDIVIDUALLY;
    ...
    buildingConfigs[StructureType::STONEMASON]->structurePlacing = StructurePlacing::INDIVIDUALLY;
    ...
    buildingConfigs[StructureType::OFFICE1]->structurePlacing = StructurePlacing::INDIVIDUALLY;
    ...
    buildingConfigs[StructureType::MARKETPLACE]->structurePlacing = StructurePlacing::INDIVIDUALLY;
    ...
    buildingConfigs[StructureType::FORESTERS]->structurePlacing = StructurePlacing::INDIVIDUALLY;
    ...
    buildingConfigs[StructureType::SHEEP_FARM]->structurePlacing = StructurePlacing::INDIVIDUALLY;
    ...
    buildingConfigs[StructureType::WEAVING_MILL1]->structurePlacing = StructurePlacing::INDIVIDUALLY;
    ...
    buildingConfigs[StructureType::CATTLE_FARM]->structurePlacing = StructurePlacing::INDIVIDUALLY;
    ...
    buildingConfigs[StructureType::BUTCHERS]->structurePlacing = StructurePlacing::INDIVIDUALLY;
    ...
    buildingConfigs[StructureType::TOOLSMITHS]->structurePlacing = StructurePlacing::INDIVIDUALLY;
    ...
    buildingConfigs[StructureType::HUNTERS_HUT]->structurePlacing = StructurePlacing::INDIVIDUALLY;
    ...
    buildingConfigs[StructureType::CATHEDRAL]->structurePlacing = StructurePlacing::INDIVIDUALLY;
    ...
    buildingConfigs[StructureType::TAVERN]->structurePlacing = StructurePlacing::INDIVIDUALLY;
