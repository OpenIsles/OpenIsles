...
BuildingConfigMgr::BuildingConfigMgr() {
    ...
    configs[StructureType::TOOLSMITHS] = new BuildingConfig();
    configs[StructureType::TOOLSMITHS]->name = "Werkzeugschmiede";
    configs[StructureType::TOOLSMITHS]->catchmentArea = new RectangleData<char>(32, 32);
    memcpy(configs[StructureType::TOOLSMITHS]->catchmentArea->data, "", 1024);
    configs[StructureType::TOOLSMITHS]->buildingCosts = { 150, 3, 2, 5 };
    configs[StructureType::TOOLSMITHS]->buildingProduction = {
        GoodsSlot(GoodsType::TOOLS, 5),
        GoodsSlot(),
        GoodsSlot()
    };
    configs[StructureType::TOOLSMITHS]->productionRate = 2.5;
}
